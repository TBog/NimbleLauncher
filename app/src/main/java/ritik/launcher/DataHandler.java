...
import ritik.launcher.dataprovider.ContactsProvider;
import ritik.launcher.dataprovider.IProvider;
import ritik.launcher.dataprovider.Provider;
...
import ritik.launcher.db.ValuedHistoryRecord;
import ritik.launcher.pojo.Pojo;
import ritik.launcher.pojo.PojoComparator;
...
public class DataHandler extends BroadcastReceiver
    ...
    protected Intent providerName2Intent(String name) {
        ...
        className.append("ritik.launcher.dataprovider.");
    ...
    public ArrayList<Pojo> getHistory(Context context, int itemCount, boolean smartHistory, ArrayList<Pojo> itemsToExclude) {
        ...
        for (int i = 0; i < ids.size(); i++) {
            ...
            if (pojo != null) {
                ...
                Log.d("Ritik", "datahandler...getHistory:   "+pojo.displayName);
            }
        }
