...
import ritik.launcher.loader.LoadAppPojos;
import ritik.launcher.normalizer.StringNormalizer;
import ritik.launcher.pojo.AppPojo;
import ritik.launcher.pojo.Pojo;
import ritik.launcher.broadcast.PackageAddedRemovedHandler;
			...
			this.registerReceiver(new BroadcastReceiver() {
				...
				public void onReceive(Context context, Intent intent) {
					if(intent.getAction().equals(Intent.ACTION_MANAGED_PROFILE_ADDED)) {
						...
						Application.getDataHandler(context).removeFromExcluded(user);
						Application.getDataHandler(context).removeFromFavorites(user);
						AppProvider.this.reload();
					}
				}
			}, filter);
