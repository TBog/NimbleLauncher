...
/**
 * Public interface exposed by every launcher data provider
 */
public interface IProvider {
     ...
     *
     * `"ritik.summon.LOAD_OVER"` will be emitted once the reload is complete. The data provider
     ...
     * `"ritik.summon.LOAD_OVER"` intent for notification of when the provider is ready.
     *
