package ritik.launcher.toggles;
...
public class TogglesHandler {
    ...
    private Boolean getTorchState() {
        return Application.getCameraHandler().isTorchAvailable() && Application.getCameraHandler().getTorchState();
    }

    private void setTorchState(Boolean state) {
        if(Application.getCameraHandler().isTorchAvailable()) {
            Application.getCameraHandler().setTorchState(state);
        }
    }
